...
impl ListLocationsResponse {
    ...
    pub(crate) fn get_next_page_token(&self) -> Result<&String, gax::error::Error> {
        self.next_page_token
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'next_page_token' is missing"))
    }
}
...
impl Location {
    ...
    pub(crate) fn get_name(&self) -> Result<&String, gax::error::Error> {
        self.name
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'name' is missing"))
    }
    ...
    pub(crate) fn get_location_id(&self) -> Result<&String, gax::error::Error> {
        self.location_id
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'location_id' is missing"))
    }
    ...
    pub(crate) fn get_display_name(&self) -> Result<&String, gax::error::Error> {
        self.display_name
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'display_name' is missing"))
    }
...
impl ListSecretsResponse {
    ...
    pub(crate) fn get_total_size(&self) -> Result<&i32, gax::error::Error> {
        self.total_size
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'total_size' is missing"))
    }
}
...
impl Secret {
    ...
    pub(crate) fn get_expire_time(&self) -> Result<&wkt::Timestamp, gax::error::Error> {
        self.expire_time
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'expire_time' is missing"))
    }
    ...
    pub(crate) fn get_ttl(&self) -> Result<&wkt::Duration, gax::error::Error> {
        self.ttl
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'ttl' is missing"))
    }
    ...
    pub(crate) fn get_etag(&self) -> Result<&String, gax::error::Error> {
        self.etag
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'etag' is missing"))
    }
...
impl Replication {
    ...
    pub(crate) fn get_automatic(&self) -> Result<&crate::model::Automatic, gax::error::Error> {
        self.automatic
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'automatic' is missing"))
    }
    ...
    pub(crate) fn get_user_managed(&self) -> Result<&crate::model::UserManaged, gax::error::Error> {
        self.user_managed
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'user_managed' is missing"))
    }
}
...
impl Replica {
    ...
    pub(crate) fn get_location(&self) -> Result<&String, gax::error::Error> {
        self.location
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'location' is missing"))
    }
...
impl SecretPayload {
    ...
    pub(crate) fn get_data(&self) -> Result<&bytes::Bytes, gax::error::Error> {
        self.data
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'data' is missing"))
    }
    ...
    pub(crate) fn get_data_crc_32_c(&self) -> Result<&i64, gax::error::Error> {
        self.data_crc_32_c
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'data_crc_32_c' is missing"))
    }
}
...
impl SecretVersion {
    ...
    pub(crate) fn get_state(&self) -> Result<&String, gax::error::Error> {
        self.state
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'state' is missing"))
    }
    ...
    pub(crate) fn get_client_specified_payload_checksum(&self) -> Result<&bool, gax::error::Error> {
        self.client_specified_payload_checksum
            .as_ref()
            .ok_or_else(|| {
                gax::error::Error::other("field 'client_specified_payload_checksum' is missing")
            })
    }
...
impl ReplicationStatus {
    ...
    #[allow(dead_code)]
    pub(crate) fn get_automatic(
        &self,
    ) -> Result<&crate::model::AutomaticStatus, gax::error::Error> {
        self.automatic
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'automatic' is missing"))
    }
    ...
    #[allow(dead_code)]
    pub(crate) fn get_user_managed(
        &self,
    ) -> Result<&crate::model::UserManagedStatus, gax::error::Error> {
        self.user_managed
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'user_managed' is missing"))
    }
...
impl UserManagedStatus {
    ...
    pub(crate) fn get_replicas(
        &self,
    ) -> Result<&Vec<crate::model::ReplicaStatus>, gax::error::Error> {
        Ok(&self.replicas)
    }
}
...
impl Policy {
    ...
    pub(crate) fn get_version(&self) -> Result<&i32, gax::error::Error> {
        self.version
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'version' is missing"))
    }
...
impl Binding {
    ...
    pub(crate) fn get_role(&self) -> Result<&String, gax::error::Error> {
        self.role
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'role' is missing"))
    }
...
impl Expr {
    ...
    pub(crate) fn get_expression(&self) -> Result<&String, gax::error::Error> {
        self.expression
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'expression' is missing"))
    }
    ...
    pub(crate) fn get_title(&self) -> Result<&String, gax::error::Error> {
        self.title
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'title' is missing"))
    }
    ...
    pub(crate) fn get_description(&self) -> Result<&String, gax::error::Error> {
        self.description
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'description' is missing"))
    }
...
impl AuditConfig {
    ...
    pub(crate) fn get_service(&self) -> Result<&String, gax::error::Error> {
        self.service
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'service' is missing"))
    }
...
impl AuditLogConfig {
    ...
    pub(crate) fn get_log_type(&self) -> Result<&String, gax::error::Error> {
        self.log_type
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'log_type' is missing"))
    }
...
impl ListLocationsRequest {
    ...
    pub(crate) fn get_filter(&self) -> Result<&String, gax::error::Error> {
        self.filter
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'filter' is missing"))
    }
    ...
    pub(crate) fn get_page_size(&self) -> Result<&i32, gax::error::Error> {
        self.page_size
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'page_size' is missing"))
    }
    ...
    pub(crate) fn get_page_token(&self) -> Result<&String, gax::error::Error> {
        self.page_token
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'page_token' is missing"))
    }
}
...
impl CreateSecretRequest {
    ...
    pub(crate) fn get_request_body(&self) -> Result<&crate::model::Secret, gax::error::Error> {
        self.request_body
            .as_ref()
            .ok_or_else(|| gax::error::Error::other("field 'request_body' is missing"))
    }
...
impl GetIamPolicyRequest {
    ...
    pub(crate) fn get_options_requested_policy_version(&self) -> Result<&i32, gax::error::Error> {
        self.options_requested_policy_version
            .as_ref()
            .ok_or_else(|| {
                gax::error::Error::other("field 'options_requested_policy_version' is missing")
            })
    }
}
